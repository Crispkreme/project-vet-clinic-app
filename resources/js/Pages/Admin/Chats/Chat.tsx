...
import UserAttachment from "@/Components/Chats/UserAttachment";
          ...
          <div className="flex-1 p:2 sm:pb-6 justify-between flex flex-col h-screen hidden xl:flex">
            ...
            <div className="border-t-2 border-gray-200 px-4 pt-4 mb-16">
              <div className="relative flex">
                ...
                <input className="focus:ring-red-500 focus:border-red-500 w-full focus:placeholder-gray-400 text-gray-600 placeholder-gray-300 pl-12 bg-gray-100 rounded-full py-3 border-gray-200" placeholder="Write something"/>
              </div>
            </div>
          </div>
        </div>
